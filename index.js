...
const userdata=JSON.parse(userdataF.data.files[fileKeyF].content);
        ...
        else res.send("New User? Get a different user name, old user? wrong password-Try Harder"); //password doesn't match/username already taken
     }
     else{
        ...
        const octokit = new Octokit({
          ...
          await octokit.request('PATCH /gists/{gist_id}', {
            gist_id: '6ea841d08fb82c6ee876d34ce3adf812',
...
const usersds=JSON.parse(usersdsF.data.files[fileKeyF].content);
    ...
    const octokit2 = new Octokit({
      ...
      await octokit2.request('PATCH /gists/{gist_id}', {
        gist_id: '76dc02015c9f796f2b24051eeb04f49d',
